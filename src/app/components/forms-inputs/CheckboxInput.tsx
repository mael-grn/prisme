...
export default function BubbleCheckbox({ checked, onChange, className = '' }: SimpleCheckboxProps) {
    return (
        <motion.label
            ...
            className={`
                ...
                ${checked ? 'bg-white/20 border-white/40' : 'bg-black/10 border-gray-300/30'}
                ${className}
            `}
        >
            <input
