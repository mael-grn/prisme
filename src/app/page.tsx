...
export default function Page() {
    ...
    return <main className="w-full h-screen overflow-hidden flex flex-col items-center justify-center gap-3">
        <img src={"/img/icon.png"} alt={"icon"} className={"md:w-52 w-38 h-fit"}/>
        <h1>Bienvenue sur Prisme !</h1>
        <p className={"text-center mt-8 mb-20"}>Créez facilement des sites internet, rendez les accessible et gérez leurs contenus en temps réel !</p>
